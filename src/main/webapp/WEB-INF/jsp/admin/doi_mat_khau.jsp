...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/change-pwd.css">
<link rel="stylesheet"
...
<body>
			...
			<div class="navbar-collapse collapse navbar-right">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown">Quản lý người dùng<b class="caret"></b>
					</a>
					...
					<li class="username dropdown active"><a href="#"
						...
						<ul class="dropdown-menu">
							<li><a href="<%=request.getContextPath()%>/home/dangxuat">Đăng
									xuất</a></li>
							<li><a
								href="<%=request.getContextPath()%>/admin/doi_mat_khau">Đổi
									mật khẩu</a></li>
						</ul></li>
				</ul>
			</div>
	...
	<div class="container">
			...
			<h4>
				<%
					if (session.getAttribute("them_xoa_sua") != null) {
						out.println(session.getAttribute("them_xoa_sua").equals("thanhcong")
								? "Tác vụ được thực hiện thành công" : "Tác vụ thất bại");
					}
		...
		<div class="row change-pwd">
			...
			<div class="change-pwd-login change-pwd-center">
				<form
					action="<%=request.getContextPath()%>/admin/xu_ly_doi_mat_khau"
					class="form-horizontal" method="POST" class="form" role="form">
					<div class="form-group">
						<div class="cols-sm-10">
							<div class="input-group">
								<label for="matKhauCu" class="cols-sm-2 control-label">Mật
									khẩu cũ:</label> <input type="password" class="form-control"
									name="matKhauCu" id="matKhauCu" required />
							</div>
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<label for="matKhauCu" class="cols-sm-2 control-label">Mật
									...
									name="matKhauMoi1" id="password" required />
							</div>
					...
					<div class="form-group">
						<div class="cols-sm-10">
							<div class="input-group">
								<label for="matKhauXN" class="cols-sm-2 control-label">Xác
									nhận mật khẩu:</label> <input type="password" class="form-control"
									name="matKhauMoi2" id="confirm_password" required />
					...
					<div class="form-group">
						<button type="submit"
							class="btn btn-primary btn-lg btn-block change-pwd-button"
							onclick="checkPW()">Đổi mật khẩu</button>
					</div>
				</form>
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/change-pwd.js"></script>
</body>
</html>