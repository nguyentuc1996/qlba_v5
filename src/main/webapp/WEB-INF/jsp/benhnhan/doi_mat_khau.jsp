                ...
                <div class="navbar-collapse collapse navbar-right">
                    ...
                    <li class="username dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="${pageContext.request.contextPath}/benhnhan/doi_mat_khau">Đổi mật khẩu</a></li>
                        </ul>
                    </li>
                </ul>
                </div><!--/.nav-collapse -->
...
<!-- 	Thêm chỗ này vào tất cả cái trang khác -->
			<div class="row change-pwd">
				...
				<div class="change-pwd-login change-pwd-center">
                    <form action="<%=request.getContextPath()%>/benhnhan/xu_ly_doi_mat_khau" class="form-horizontal" method="POST" class="form" role="form">
